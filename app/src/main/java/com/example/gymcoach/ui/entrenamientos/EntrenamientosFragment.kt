package com.example.gymcoach.ui.entrenamientos
...
import com.example.gymcoach.databinding.FragmentEntrenamientosBinding
...
private var _binding: FragmentEntrenamientosBinding? = null
  ...
  override fun onCreateView(
    ...
    entrenamientosViewModel.text.observe(viewLifecycleOwner) {
      textView.text = it
    }
    return root
  }
